...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'myrandebandi/templates')],  # location of your overriding templates
        'OPTIONS': {
            'context_processors': [
...
VOCABULARY = {
    ...
    'co_member' : 'Rande-Gspändli',
    'co_member_pl' : 'Rande-Gspändlis',
...
EMAILS = {
    ...
    'j_reminder': 'randebandi_emails/job_reminder.txt'
}
